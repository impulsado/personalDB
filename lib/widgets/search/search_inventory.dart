...
class SearchBarInventory extends StatefulWidget {
...
class _SearchBarInventoryState extends State<SearchBarInventory> {
          ...
          child: Column(
            children: <Widget>[
              ...
              ListTile(
                ...
                onTap: () => _selectOrderOption(context, "Location"),
              ),
              ListTile(
