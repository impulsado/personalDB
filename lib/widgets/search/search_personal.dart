...
class SearchBarPersonal extends StatefulWidget {
  ...
  _SearchBarPersonalState createState() => _SearchBarPersonalState();
}

class _SearchBarPersonalState extends State<SearchBarPersonal> {
