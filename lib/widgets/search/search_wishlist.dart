...
class SearchBarWishlist extends StatefulWidget {
  ...
  _SearchBarWishlistState createState() => _SearchBarWishlistState();
}

class _SearchBarWishlistState extends State<SearchBarWishlist> {
          ...
          child: Column(
            children: <Widget>[
              ...
              ListTile(
                ...
                onTap: () => _selectOrderOption(context, "Priority"),
              ),
              ListTile(
