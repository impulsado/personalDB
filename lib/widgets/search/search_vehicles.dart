...
class SearchBarVehicles extends StatefulWidget {
  ...
  _SearchBarVehiclesState createState() => _SearchBarVehiclesState();
}

class _SearchBarVehiclesState extends State<SearchBarVehicles> {
          ...
          child: Column(
            children: <Widget>[
              ...
              ListTile(
                ...
                title: const Text("Sort by Next Maintance"),
                onTap: () => _selectOrderOption(context, "Next Maintance"),
              ),
            ],
          ),
        );
