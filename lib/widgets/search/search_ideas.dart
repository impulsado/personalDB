...
class SearchBarIdeas extends StatefulWidget {
  ...
  _SearchBarIdeasState createState() => _SearchBarIdeasState();
}

class _SearchBarIdeasState extends State<SearchBarIdeas> {
