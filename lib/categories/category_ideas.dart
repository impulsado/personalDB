      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return Padding(
            ...
            child: Container(
              width: double.infinity,  // This ensures that the note takes up the full available width
              padding: const EdgeInsets.all(8.0),
              ...
              child: Stack(
                children: [
                  Padding(
                    padding: EdgeInsets.only(right: 50.0, left: 13.0),  // Padding to avoid text overlap with the close button
