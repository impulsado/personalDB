...
import 'package:personaldb/widgets/search/search_ideas.dart';
...
class CategoryIdeas extends StatefulWidget {
  ...
  const CategoryIdeas(this.myCategory, {Key? key}) : super(key: key);
...
class _CategoryIdeasState extends State<CategoryIdeas> with TickerProviderStateMixin {
