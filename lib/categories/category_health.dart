...
import 'package:personaldb/widgets/search/search_health.dart';
...
class CategoryHealth extends StatefulWidget {
  ...
  const CategoryHealth(this.myCategory, {super.key});
...
class _CategoryHealthState extends State<CategoryHealth> with TickerProviderStateMixin {
