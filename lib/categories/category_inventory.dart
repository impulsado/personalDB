...
class MyAppInventory extends StatelessWidget {
  const MyAppInventory({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      theme: Themes.light,
      home: CategoryInventory(MyCategory()),
    );
  }
}
...
class CategoryInventory extends StatefulWidget {
  ...
  const CategoryInventory(this.myCategory, {super.key});

  @override
  // ignore: library_private_types_in_public_api
  _CategoryInventoryState createState() => _CategoryInventoryState();
}
