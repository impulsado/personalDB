...
import 'package:personaldb/widgets/search/search_checklists.dart';

void main() {
  runApp(const MyAppCheckList());
}

class MyAppCheckList extends StatelessWidget {
  const MyAppCheckList({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      theme: Themes.light,
      home: CategoryCheckList(MyCategory()),
    );
  }
}
...
class CategoryCheckList extends StatefulWidget {
  ...
  const CategoryCheckList(this.myCategory, {super.key});

  @override
  // ignore: library_private_types_in_public_api
  _CategoryCheckListState createState() => _CategoryCheckListState();
}

class _CategoryCheckListState extends State<CategoryCheckList> with TickerProviderStateMixin {
                ...
                setState(() {
                  ...
                  switch (result) {
                    case "Title":
                      ...
                      break;
                    case "Duration":
                      _notes.sort((a, b) => _isAscending ? a["duration"].toString().compareTo(b["duration"].toString()) : b["duration"].toString().compareTo(a["duration"].toString()));
                      break;
                    case "Price":
