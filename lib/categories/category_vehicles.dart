...
import 'package:personaldb/widgets/search/search_vehicles.dart';

void main() {
  runApp(const MyAppVehicles());
}

class MyAppVehicles extends StatelessWidget {
  const MyAppVehicles({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      theme: Themes.light,
      home: CategoryVehicles(MyCategory()),
    );
  }
}

class CategoryVehicles extends StatefulWidget {
  final MyCategory myCategory;

  const CategoryVehicles(this.myCategory, {super.key});

  @override
  // ignore: library_private_types_in_public_api
  _CategoryVehiclesState createState() => _CategoryVehiclesState();
}

class _CategoryVehiclesState extends State<CategoryVehicles> with TickerProviderStateMixin {
                ...
                setState(() {
                  ...
                  switch (result) {
                    ...
                    case "Next Maintenance":
                      _notes.sort((a, b) => _isAscending ? a["next_maintenance"].toString().compareTo(b["next_maintenance"].toString()) : b["next_maintenance"].toString().compareTo(a["next_maintenance"].toString()));
                      break;
                  }
                });
              },
